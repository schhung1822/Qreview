        ...
        <section className="overflow-hidden py-20 bg-background dark:bg-dark">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              <h2 className="font-medium text-foreground text-2xl">Danh sách yêu thích</h2>
              <button className="text-blue">Xóa tất cả</button>
            </div>

            <div className="bg-surface dark:bg-surface rounded-[10px] shadow-1">
                ...
                <div className="min-w-[1170px]">
                  ...
                  <div className="flex items-center py-5.5 px-7.5">
                    ...
                    <div className="min-w-[50px]">
                      <p className="text-foreground text-right">Action</p>
                    </div>
                  </div>
